...
#   name = "adminAWSAccount"
# }

# data "aws_secretsmanager_secret_version" "secret-version" {
#   secret_id = data.aws_secretsmanager_secret.adminAWSAccount.id
# }

# locals {
#   creds = jsondecode(data.aws_secretsmanager_secret_version.secret-version.secret_string)
# }
...
#   secret_key = local.creds.secret_access_key
# }
